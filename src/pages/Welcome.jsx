...
export default function WelcomePage() {
  // Get ra số pixel đã scroll
  const { scrollY } = useScroll();

  // Khi scroll Y từ 0px đến 200px, ta sẽ quy đổi ra con số để sử dụng trong animation là 1 đến 0.5
  // Ta có thể áp dụng cho opacity, khi scroll từ 0px đến 200px, opacity giảm từ 1 về 0.5
  ...
  return (
    <>
      <header id="welcome-header">
        ...
        <motion.img
          // style prop sẽ được theo dõi bởi framer motion
          // khi có sự thay đổi, animaton sẽ tự động được áp dụng
